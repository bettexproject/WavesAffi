<template>
    <v-layout justify-center align-center class="login">
        ...
        <div class="login-card">
            ...
            <div class="login-button mb-2" @click="login">Login with
                <div class="keeper-logo"/>
            </div>
            <div v-if="isKeeperInstalled === false" class="login-description caption">
                You need an installed <a href="https://wavesplatform.com/products-keeper" target="_blank">WAVES
                Keeper</a> to use this app
            </div>
            <v-alert v-model="showAlert" dismissible>{{loginError}}</v-alert>
        </div>
...
<script>
    ...
    export default {
        computed: {
            ...mapGetters(['isKeeperInstalled', 'loginError']),
            showAlert: {
                get() {
